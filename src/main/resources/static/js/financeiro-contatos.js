...
(function (window, document) {
	...
	function renderizar(contatos) {
		var corpo = el("contatos-tbody"); corpo.innerHTML = ""; contatos.forEach(function (contato) {
			...
			var acoes = td(""); acoes.className = "criati-table-acoes"; var editar = document.createElement("button"); editar.type = "button"; editar.className = "criati-btn criati-btn-ghost"; editar.textContent = "Editar"; editar.addEventListener("click", function () { abrir(contato); }); acoes.appendChild(editar);
