...
-- Ressarcimento de compra para terceiro nunca gera lancamento_financeiro: o
-- principal ressarcido nao e receita nem despesa da residencia, apenas a
-- devolucao de um valor que ela adiantou (CRIATI-FIN-013A). O impacto de
-- caixa fica inteiramente registrado aqui (conta_id + valor + status) e e
-- somado ao saldo da conta pela aplicacao (SaldoFinanceiroService), fora da
